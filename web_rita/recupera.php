				...
				if (mysqli_num_rows($queryExisteCorreo) == null) {
					echo "Ese correo no está registrado. Registrate por favor";
					 mysqli_close($conectar);
					   ...
					   $mensaje = "Para recuperar tu contraseña pulsa <a href='https://loscuadrosderita.com/demo/recover.php?id=".$idUser."' target='blank'>aquí</a>";
					   ...
					   mail($receptor, $asunto, $mensaje, $cabecera);	
				         ...
				         mysqli_close($conectar);
                 echo "<script>alert('Reviza tu Correo')</script>";
					  }
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-0 mb-lg-0 conteNav">
        ...
        <li class="nav-item">
          <a class="nav-link active">Recuperar Contraseña</a>
        </li>
        <li class="nav-item">
...
<section class="sectionRecupera" style="">
 ...
 <div class="marcoRecupera" style="">
   <div class="conteRegistro" style="">
      <h1 class="titleR">Recuperar Contraseña</h1>
